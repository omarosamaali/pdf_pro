                ...
                <div class="tab-panel active" id="all">
                    <div class="content-grid">
                        <a href="{{ route('pdf_to_jpg') }}" class="content-card special-effect glow-effect">
                            ...
                            <h3 class="card-title">Convert to JPG</h3>
                            <p class="card-description">Convert your files to high-quality JPG images.</p>
                        </a>
                        <a href="{{ route('pdf_to_word') }}" class="content-card special-effect">
                            ...
                            <h3 class="card-title">Convert to Word</h3>
                            <p class="card-description">Convert PDF or other files to editable Word documents.</p>
                        </a>
                        <a href="{{ route('pdf_to_powerpoint') }}" class="content-card special-effect">
                            ...
                            <h3 class="card-title">Convert to PowerPoint</h3>
                            <p class="card-description">Convert your files to PowerPoint presentations.</p>
                        </a>
                        <a href="{{ route('pdf_to_excel') }}" class="content-card special-effect">
                            ...
                            <h3 class="card-title">Convert to Excel</h3>
                            <p class="card-description">Convert data to organized Excel spreadsheets.</p>
                        </a>
                        <a href="{{ route('images_to_pdf') }}" class="content-card special-effect">
                            ...
                            <p class="card-description">Easily convert images to PDF files.</p>
                        </a>
                        <a href="{{ route('compress_pdf') }}" class="content-card special-effect">
                            ...
                            <p class="card-description">Reduce file size while maintaining quality.</p>
                        </a>
                        <a href="{{ route('merge_pdf') }}" class="content-card special-effect">
                            ...
                            <p class="card-description">Merge multiple PDF files into one.</p>
                        </a>
                        <a href={{ route('rotate_pdf') }} class="content-card special-effect">
                            ...
                            <p class="card-description">Rotate file pages to adjust orientation.</p>
                        </a>
                        <a href={{ route('add_watermark') }} class="content-card special-effect">
                            ...
                            <h3 class="card-title">Add Watermark</h3>
                            <p class="card-description">Add watermarks to secure or customize your files.</p>
                        </a>
                    </div>
                </div>
