...
<div class="px-4 py-0 text-center bg-gray-100">
    ...
    <div class="mx-auto max-w-7xl py-5">
        <div id="initial-content">
            <h1 class="text-[24px] w-full md:text-[42px] font-bold text-[#33333b] my-2">PDF to Word Conversion</h1>
            <p class="max-w-5xl mx-auto text-[16px] md:text-[22px] text-gray-700 mb-4">
                Convert any PDF to Word (.docx) with high quality
            </p>
        ...
        <div id="file-card" class="hidden mt-6">
            <div class="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto border-2 border-gray-200">
                ...
                <div class="text-center mb-4">
                    ...
                    <p id="conversion-note" class="text-xs text-gray-600">The file will be converted to a Word document (.docx)</p>
                </div>
...
<script>
    ...
    function openFilePicker() {
        // إعادة تعيين الـ input قبل فتح picker جديد
        fileInput.value = '';
        fileInput.click();
    }
    ...
    function handleFileSelect(event) {
        ...
        if (file) {
            ...
            if (file.type !== 'application/pdf') {
                ...
                // إعادة تعيين الـ input في حالة الملف الخطأ
                fileInput.value = '';
                return;
            }
    ...
    function selectAnotherFile() {
        // إعادة تعيين كل الحالة والعناصر
        resetToInitialState();
    }

    function resetToInitialState() {
        // إظهار المحتوى الأولي
        ...
        // إزالة drag-over class لو موجودة
        dropZone.classList.remove('drag-over');
    }
