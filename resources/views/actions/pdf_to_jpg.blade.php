...
<div class="px-4 py-0 text-center bg-gray-100">
    <div class="mx-auto max-w-7xl py-5">
        <!-- Initial Content - Title and Description -->
        <div id="initial-content">
            <h1 class="text-[24px] w-full md:text-[42px] font-bold text-[#33333b] my-2">PDF to JPG Conversion</h1>
            <p class="max-w-5xl mx-auto text-[16px] md:text-[22px] text-gray-700 mb-4">
                Convert any PDF to JPG with high quality
            </p>
        ...
        <div id="file-card" class="hidden mt-6">
            <div class="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto border-2 border-gray-200">
                ...
                <div id="pdf-info" class="text-center mb-4">
                    <div class="bg-blue-50 rounded-lg p-3 mb-3">
                        <p class="text-sm text-blue-800">
                            <strong>Number of Pages:</strong> <span id="pdf-pages">Calculating...</span>
                        </p>
                        <p class="text-xs text-blue-600 mt-1">Each page will be converted to a separate JPG image and downloaded as a ZIP file</p>
                    </div>
                </div>
                ...
                <div class="text-center mb-4">
                    ...
                    <p id="conversion-note" class="text-xs text-gray-600">Each page will be converted to a separate JPG and downloaded as a ZIP file</p>
                </div>
...
<script>
    ...
    async function handleFileSelect(event) {
        ...
        if (file) {
            ...
            // Show PDF icon and PDF info
            document.getElementById('pdf-icon').classList.remove('hidden');
    ...
    async function uploadAndConvert() {
        ...
        try {
            ...
            const response = await fetch('/convert-pdf_to_jpg', {
                method: 'POST'
                , body: formData
                , headers: {
            ...
            Swal.fire({
                ...
                , text: 'Your PDF has been converted to JPG images and downloaded as a ZIP file! ✅'
                , confirmButtonColor: '#3085d6'
                , confirmButtonText: 'OK'
            });
